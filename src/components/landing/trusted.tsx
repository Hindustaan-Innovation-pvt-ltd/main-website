        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {clients.map((client, index) => (
            <motion.div
              ...
              className="bg-white rounded-2xl h-[120px] flex items-center justify-center hover:shadow-lg transition-all duration-300 border border-transparent cursor-pointer group"
            >
              <div className="flex items-center gap-2 text-zinc-800 group-hover:scale-110 max-lg:group-data-[in-view=true]:scale-110 transition-transform duration-300">
                {client.icon && (
                  <client.icon className="w-7 h-7 fill-zinc-800 text-zinc-800" />
                )}
          ...
          <motion.div
            ...
            className="bg-[#222222] rounded-2xl h-[120px] flex items-center justify-center hover:scale-[1.02] transition-transform duration-300 cursor-pointer shadow-xl"
          >
