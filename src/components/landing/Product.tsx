...
import { ArrowRight, ArrowUpRight, Hexagon, Heart, Zap, Sun } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex justify-between items-center mb-12 relative z-10">
              ...
              <div className="flex items-center gap-1 text-zinc-500 font-medium text-sm group-hover:text-black max-lg:group-data-[in-view=true]:text-black transition-colors cursor-pointer">
                Health Tracker App <ArrowUpRight className="w-4 h-4" />
              </div>
            </div>
          ...
          >
            ...
            {/* Browser Mockup */}
            <div className="relative flex w-full rounded-t-xl bg-zinc-100 border border-zinc-200 overflow-hidden shadow-lg group-hover:-translate-y-2 max-lg:group-data-[in-view=true]:-translate-y-2 transition-transform duration-500 flex-col">
               {/* Browser Top Bar */}
