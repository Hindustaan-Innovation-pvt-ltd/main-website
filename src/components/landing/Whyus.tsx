        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 gap-8">
          <div className="max-w-3xl">
            ...
            <motion.h2 
              ...
              className="text-4xl md:text-4xl lg:text-5xl font-bold text-zinc-900 dark:text-white leading-[1.1] tracking-tight"
            >
...
function Card({ title, desc, illustration, className = "" }: { title: string, desc: string, illustration: React.ReactNode, className?: string }) {
  return (
    <motion.div
      ...
      className={`bg-white dark:bg-zinc-900/90 rounded-[1.5rem] sm:rounded-[2rem] p-5 sm:p-8 pb-0 sm:pb-0 flex flex-col shadow-xs border border-zinc-200/60 dark:border-white/10 overflow-hidden group hover:shadow-xl transition-all ${className}`}
    >
      <h3 className="text-lg sm:text-xl font-bold text-zinc-900 dark:text-white mb-2">{title}</h3>
      <p className="text-zinc-500 dark:text-zinc-400 font-medium text-xs sm:text-sm leading-relaxed mb-6 sm:mb-8">
        {desc}
      </p>
...
function DesignDirectlyIllustration() {
  return (
    <div className="absolute inset-0 flex justify-center w-full h-full overflow-hidden">
      ...
      {/* Desktop Frame */}
      <div className="absolute top-6 right-2 sm:right-6 w-[95%] sm:w-[80%] h-[85%] bg-zinc-50/80 dark:bg-zinc-800/70 backdrop-blur-sm rounded-t-xl border border-zinc-200 dark:border-white/10 shadow-sm p-3 flex flex-col">
         {/* Desktop Header */}
         <div className="flex items-center justify-between mb-5 px-1">
           <div className="w-5 h-5 rounded-full bg-zinc-200 dark:bg-zinc-700"></div>
           <div className="flex gap-2">
             <div className="w-10 h-1.5 rounded-full bg-zinc-200 dark:bg-zinc-700"></div>
             <div className="w-6 h-1.5 rounded-full bg-zinc-200 dark:bg-zinc-700"></div>
             <div className="w-6 h-1.5 rounded-full bg-zinc-200 dark:bg-zinc-700"></div>
           </div>
         ...
         {/* Desktop Body */}
         <div className="flex-1 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-white/10 rounded-lg p-5 flex flex-col relative overflow-hidden">
            
            {/* Top Area */}
            <div className="flex flex-col items-center gap-2.5 mb-8 mt-2">
               <div className="w-40 h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
               
               {/* Animated Line */}
               <div className="relative h-2 bg-zinc-800 dark:bg-zinc-300 rounded-full transition-all duration-700 w-12 group-hover:w-40 max-lg:group-data-[in-view=true]:w-40 self-center">
                  {/* Designer Cursor Top */}
               ...
               <div className="w-20 h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
               <div className="w-10 h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
            </div>

            {/* Grid Area */}
            <div className="grid grid-cols-3 gap-3 mb-6">
               <div className="h-16 bg-zinc-50 dark:bg-zinc-800/60 rounded-lg border border-zinc-100 dark:border-white/5"></div>
               <div className="h-16 bg-zinc-50 dark:bg-zinc-800/60 rounded-lg border border-zinc-100 dark:border-white/5"></div>
               <div className="h-16 bg-zinc-50 dark:bg-zinc-800/60 rounded-lg border border-zinc-100 dark:border-white/5"></div>
            </div>
            ...
            <div className="flex justify-between items-start mt-auto pb-2">
               <div className="w-16 h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full mt-2"></div>
               
               {/* Animated Pill Bottom */}
               <div className="flex flex-col gap-2.5 w-1/2">
                  <div className="relative h-2.5 bg-zinc-800 dark:bg-zinc-300 rounded-full transition-all duration-700 w-12 group-hover:w-32 max-lg:group-data-[in-view=true]:w-32 ml-auto">
                  ...
                  <div className="w-16 h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full ml-auto"></div>
                  <div className="w-12 h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full ml-auto"></div>
               </div>
            </div>
      ...
      {/* Mobile Frame */}
      <div className="absolute bottom-[-10px] left-2 sm:left-6 w-[60%] sm:w-[45%] h-[75%] bg-white dark:bg-zinc-900 rounded-t-2xl border border-zinc-200 dark:border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.08)] dark:shadow-[0_0_40px_rgba(0,0,0,0.4)] p-2.5 z-30 flex flex-col">
         {/* Mobile Header */}
         <div className="flex justify-between items-start mb-4 px-1">
           <div className="flex flex-col gap-1.5 mt-1">
             <div className="w-8 h-1.5 rounded-full bg-zinc-200 dark:bg-zinc-700"></div>
             <div className="w-14 h-2 rounded-full bg-zinc-200 dark:bg-zinc-700"></div>
           </div>
           <div className="w-5 h-1.5 rounded-full bg-zinc-200 dark:bg-zinc-700 mt-1"></div>
         </div>

         {/* Mobile Body */}
         <div className="flex-1 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-white/10 rounded-xl p-3 flex flex-col gap-3">
            ...
            <div className="flex flex-col items-center gap-2 mt-4">
               ...
               <div className="w-20 h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full mt-1"></div>
            </div>

            <div className="w-full h-20 bg-zinc-50 dark:bg-zinc-800/60 rounded-lg border border-zinc-100 dark:border-white/5 mt-2"></div>

            <div className="w-12 h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full mt-auto mb-1"></div>
            <div className="flex gap-2 h-8">
              <div className="flex-1 h-full bg-zinc-50 dark:bg-zinc-800/60 rounded-md border border-zinc-100 dark:border-white/5"></div>
              <div className="flex-1 h-full bg-zinc-50 dark:bg-zinc-800/60 rounded-md border border-zinc-100 dark:border-white/5"></div>
              <div className="flex-1 h-full bg-zinc-50 dark:bg-zinc-800/60 rounded-md border border-zinc-100 dark:border-white/5"></div>
            </div>
         </div>
      ...
      <div className="relative w-full max-w-[360px] sm:max-w-[420px] aspect-square">
         ...
         <div className="absolute inset-0 grid grid-cols-4 grid-rows-4 gap-3 sm:gap-4 z-0">
            {Array.from({ length: 16 }).map((_, i) => (
              <div key={i} className="bg-zinc-50/70 dark:bg-zinc-800/40 rounded-[1rem] sm:rounded-[1rem] border border-zinc-100/50 dark:border-white/5" />
            ))}
         </div>
         ...
         <div className="absolute inset-0 grid grid-cols-4 grid-rows-4 gap-3 sm:gap-4 z-10">
            ...
            <div className="col-start-1 row-start-1 bg-[#1c1c1c] dark:bg-zinc-800 rounded-[1.25rem] sm:rounded-[1.5rem] flex items-center justify-center shadow-[0_8px_20px_rgba(0,0,0,0.12)] border border-zinc-700/50 dark:border-zinc-700 transition-transform duration-700 ease-in-out group-hover:translate-x-[calc(300%+2.25rem)] max-lg:group-data-[in-view=true]:translate-x-[calc(300%+2.25rem)] sm:group-hover:translate-x-[calc(300%+3rem)] sm:max-lg:group-data-[in-view=true]:translate-x-[calc(300%+3rem)] text-white">
...
<path d="M5.33 2h13.33v6.67h-6.67zm0 6.67H12l6.67 6.67H12v6.67l-6.67-6.67z"/>
            ...
            <div className="col-start-4 row-start-2 bg-[#1c1c1c] dark:bg-zinc-800 rounded-[1.25rem] sm:rounded-[1.5rem] flex items-center justify-center shadow-[0_8px_20px_rgba(0,0,0,0.12)] border border-zinc-700/50 dark:border-zinc-700 transition-transform duration-700 ease-in-out group-hover:-translate-x-[calc(100%+0.75rem)] max-lg:group-data-[in-view=true]:-translate-x-[calc(100%+0.75rem)] sm:group-hover:-translate-x-[calc(100%+1rem)] sm:max-lg:group-data-[in-view=true]:-translate-x-[calc(100%+1rem)]">
            ...
            <div className="col-start-2 row-start-4 bg-[#1c1c1c] dark:bg-zinc-800 rounded-[1.25rem] sm:rounded-[1.5rem] flex items-center justify-center shadow-[0_8px_20px_rgba(0,0,0,0.12)] border border-zinc-700/50 dark:border-zinc-700 transition-transform duration-700 ease-in-out group-hover:-translate-x-[calc(100%+0.75rem)] max-lg:group-data-[in-view=true]:-translate-x-[calc(100%+0.75rem)] sm:group-hover:-translate-x-[calc(100%+1rem)] sm:max-lg:group-data-[in-view=true]:-translate-x-[calc(100%+1rem)]">
            ...
            <div className="col-start-4 row-start-4 bg-[#1c1c1c] dark:bg-zinc-800 rounded-[1.25rem] sm:rounded-[1.5rem] flex items-center justify-center shadow-[0_8px_20px_rgba(0,0,0,0.12)] border border-zinc-700/50 dark:border-zinc-700 transition-transform duration-700 ease-in-out group-hover:-translate-x-[calc(100%+0.75rem)] max-lg:group-data-[in-view=true]:-translate-x-[calc(100%+0.75rem)] sm:group-hover:-translate-x-[calc(100%+1rem)] sm:max-lg:group-data-[in-view=true]:-translate-x-[calc(100%+1rem)]">
  ...
  return (
    <div className={`absolute inset-0 flex items-center justify-center overflow-hidden transition-transform duration-500 ${bottomLabel ? 'translate-y-4' : ''}`}>
       ...
       <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
          <line x1="50%" y1="50%" x2="35%" y2="50%" className="stroke-zinc-800 dark:stroke-zinc-400" strokeWidth="1.5" strokeDasharray="4 4" />
          <line x1="50%" y1="50%" x2="65%" y2="50%" className="stroke-zinc-800 dark:stroke-zinc-400" strokeWidth="1.5" strokeDasharray="4 4" />
          
          <line x1="35%" y1="50%" x2="20%" y2="22%" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
          <line x1="35%" y1="50%" x2="20%" y2="78%" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
          <line x1="65%" y1="50%" x2="80%" y2="22%" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
          <line x1="65%" y1="50%" x2="80%" y2="78%" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
       </svg>
       
       {/* Top-Left Node (Meet) */}
       <div className="absolute top-[22%] left-[20%] -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white dark:bg-zinc-800 rounded-full shadow-[0_6px_20px_rgba(0,0,0,0.08)] dark:shadow-[0_6px_20px_rgba(0,0,0,0.4)] border border-zinc-50 dark:border-white/10 flex items-center justify-center z-10 transition-transform duration-500 hover:scale-110">
          {/* Connection Dot */}
          <div className="absolute top-[85%] left-[85%] -translate-x-1/2 -translate-y-1/2 w-[5px] h-[5px] bg-zinc-800 dark:bg-zinc-200 rounded-full z-20" />
       ...
       <div className="absolute top-[78%] left-[20%] -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white dark:bg-zinc-800 rounded-full shadow-[0_6px_20px_rgba(0,0,0,0.08)] dark:shadow-[0_6px_20px_rgba(0,0,0,0.4)] border border-zinc-50 dark:border-white/10 flex items-center justify-center z-10 transition-transform duration-500 hover:scale-110">
          {/* Connection Dot */}
          <div className="absolute top-[15%] left-[85%] -translate-x-1/2 -translate-y-1/2 w-[5px] h-[5px] bg-zinc-800 dark:bg-zinc-200 rounded-full z-20" />
       ...
       <div className="absolute top-[22%] left-[80%] -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white dark:bg-zinc-800 rounded-full shadow-[0_6px_20px_rgba(0,0,0,0.08)] dark:shadow-[0_6px_20px_rgba(0,0,0,0.4)] border border-zinc-50 dark:border-white/10 flex items-center justify-center z-10 transition-transform duration-500 hover:scale-110">
          {/* Connection Dot */}
          <div className="absolute top-[85%] left-[15%] -translate-x-1/2 -translate-y-1/2 w-[5px] h-[5px] bg-zinc-800 dark:bg-zinc-200 rounded-full z-20" />
          <svg viewBox="0 0 24 24" fill="#a1a1aa" className="w-6 h-6">
       ...
       <div className="absolute top-[78%] left-[80%] -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white dark:bg-zinc-800 rounded-full shadow-[0_6px_20px_rgba(0,0,0,0.08)] dark:shadow-[0_6px_20px_rgba(0,0,0,0.4)] border border-zinc-50 dark:border-white/10 flex items-center justify-center z-10 transition-transform duration-500 hover:scale-110">
          {/* Connection Dot */}
          <div className="absolute top-[15%] left-[15%] -translate-x-1/2 -translate-y-1/2 w-[5px] h-[5px] bg-zinc-800 dark:bg-zinc-200 rounded-full z-20" />
...
function ProjectUpdatesIllustration() {
  return (
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden group">
       ...
       {/* Left Line */}
       <div className="absolute top-[15%] left-[10%] w-[30%] h-[40%] border-l border-b border-zinc-200 dark:border-zinc-700 rounded-bl-3xl transition-colors duration-500 group-hover:border-zinc-300 dark:group-hover:border-zinc-600 max-lg:group-data-[in-view=true]:border-zinc-300 z-0">
         <div className="absolute top-0 left-0 w-1.5 h-1.5 bg-zinc-300 dark:bg-zinc-600 rounded-full -translate-x-[3px] -translate-y-[3px] transition-all duration-200 delay-0 group-hover:delay-[400ms] max-lg:group-data-[in-view=true]:delay-[400ms] group-hover:bg-[#1ba453] max-lg:group-data-[in-view=true]:bg-[#1ba453] group-hover:scale-150 max-lg:group-data-[in-view=true]:scale-150 z-10" />
         {/* Animated Dash */}
         <div className="dash-transition absolute left-0 w-[3px] h-3 bg-zinc-600 dark:bg-zinc-300 rounded-full -translate-x-[1.5px] -translate-y-1/2 top-[80%] group-hover:top-0 max-lg:group-data-[in-view=true]:top-0 opacity-100 group-hover:opacity-0 max-lg:group-data-[in-view=true]:opacity-0" />
       </div>
       
       {/* Right Line */}
       <div className="absolute top-[50%] right-[10%] w-[30%] h-[40%] border-r border-t border-zinc-200 dark:border-zinc-700 rounded-tr-3xl transition-colors duration-500 group-hover:border-zinc-300 dark:group-hover:border-zinc-600 max-lg:group-data-[in-view=true]:border-zinc-300 z-0">
         <div className="absolute bottom-0 right-0 w-1.5 h-1.5 bg-zinc-300 dark:bg-zinc-600 rounded-full translate-x-[3px] translate-y-[3px] transition-all duration-200 delay-0 group-hover:delay-[400ms] max-lg:group-data-[in-view=true]:delay-[400ms] group-hover:bg-[#1ba453] max-lg:group-data-[in-view=true]:bg-[#1ba453] group-hover:scale-150 max-lg:group-data-[in-view=true]:scale-150 z-10" />
         {/* Animated Dash */}
         <div className="dash-transition absolute right-0 w-[3px] h-3 bg-zinc-600 dark:bg-zinc-300 rounded-full translate-x-[1.5px] -translate-y-1/2 top-[20%] group-hover:top-[100%] max-lg:group-data-[in-view=true]:top-[100%] opacity-100 group-hover:opacity-0 max-lg:group-data-[in-view=true]:opacity-0" />
       </div>
       ...
       <div className="relative flex items-center justify-center w-full h-full z-20 pointer-events-none">
         {/* Outer Ring */}
         <div className="absolute w-[220px] h-[80px] sm:w-[240px] sm:h-[90px] rounded-[50px] border border-[#1ba453]/30 bg-[#1ba453]/5 flex items-center justify-center transition-all duration-700 group-hover:scale-[1.03] max-lg:group-data-[in-view=true]:scale-[1.03] group-hover:bg-[#1ba453]/10 max-lg:group-data-[in-view=true]:bg-[#1ba453]/10">
            {/* Inner Ring */}
            <div className="w-[170px] h-[55px] sm:w-[190px] sm:h-[65px] rounded-[35px] border border-[#1ba453]/50 bg-[#1ba453]/10 flex items-center justify-center transition-all duration-700 group-hover:scale-[1.03] max-lg:group-data-[in-view=true]:scale-[1.03] group-hover:bg-[#1ba453]/20 max-lg:group-data-[in-view=true]:bg-[#1ba453]/20">
               {/* Button */}
...
function ExecutionIllustration() {
  return (
    <div className="absolute inset-0 w-full h-full group overflow-hidden bg-zinc-50/30 dark:bg-zinc-950/30">
      
      {/* S-Curve Connecting Line */}
      <div className="absolute top-[44%] left-[20%] w-[30%] h-[7%] border-l border-b border-zinc-200 dark:border-zinc-700 rounded-bl-xl transition-colors duration-500 group-hover:border-zinc-300 dark:group-hover:border-zinc-600 max-lg:group-data-[in-view=true]:border-zinc-300 z-0">
         <div className="absolute top-0 left-0 w-[2px] h-3 bg-zinc-800 dark:bg-zinc-300 rounded-full -translate-x-[1px] -translate-y-1/2 transition-transform duration-500 group-hover:scale-y-150 max-lg:group-data-[in-view=true]:scale-y-150"></div>
      </div>
      <div className="absolute top-[44%] right-[20%] w-[30%] h-[7%] border-r border-t border-zinc-200 dark:border-zinc-700 rounded-tr-xl translate-y-full transition-colors duration-500 group-hover:border-zinc-300 dark:group-hover:border-zinc-600 max-lg:group-data-[in-view=true]:border-zinc-300 z-0">
         <div className="absolute bottom-0 right-0 w-[2px] h-3 bg-zinc-800 dark:bg-zinc-300 rounded-full translate-x-[1px] translate-y-1/2 transition-transform duration-500 group-hover:scale-y-150 max-lg:group-data-[in-view=true]:scale-y-150"></div>
      </div>

      {/* Top Window (Figma) */}
      <div className="absolute top-[6%] left-1/2 -translate-x-1/2 z-10 w-[92%] sm:w-[85%] h-[38%] bg-white dark:bg-zinc-900 rounded-xl border border-zinc-100 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.4)] flex flex-col overflow-hidden transition-transform duration-500 group-hover:-translate-y-1 max-lg:group-data-[in-view=true]:-translate-y-1">
         {/* Header */}
         <div className="flex items-center justify-between px-4 py-3 bg-zinc-50/50 dark:bg-zinc-800/60 border-b border-zinc-100 dark:border-white/10">
            ...
            <div className="flex items-center gap-3">
               <div className="w-5 h-1 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
               <div className="w-7 h-1 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
               <div className="w-5 h-1 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
               <div className="w-5 h-1 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
            </div>
            <div className="w-10 h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
         ...
         {/* Body */}
         <div className="flex-1 p-5 relative bg-white dark:bg-zinc-900">
            <div className="w-[50%] h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full mb-3"></div>
            {/* Green Selected Bar */}
            ...
            <div className="w-[45%] h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full mb-2"></div>
            <div className="flex gap-2 mb-4">
               <div className="w-[15%] h-4 bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-100 dark:border-white/5 rounded"></div>
               <div className="w-[20%] h-4 bg-zinc-100 dark:bg-zinc-800 rounded"></div>
            </div>
            
            {/* Background floating rectangles in mockup */}
            <div className="absolute bottom-[-10px] right-[10%] w-[45%] h-[80%] bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200/60 dark:border-white/10 rounded-t-xl shadow-sm z-10"></div>
            <div className="absolute bottom-[-20px] right-[25%] w-[40%] h-[50%] bg-white dark:bg-zinc-900 border border-zinc-200/60 dark:border-white/10 rounded-t-xl shadow-md z-20"></div>
         </div>
      </div>

      {/* Bottom Window (Developer) */}
      <div className="absolute top-[58%] left-1/2 -translate-x-1/2 z-10 w-[92%] sm:w-[85%] h-[38%] bg-white dark:bg-zinc-900 rounded-xl border border-zinc-100 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.4)] flex flex-col overflow-hidden transition-transform duration-500 group-hover:translate-y-1 max-lg:group-data-[in-view=true]:translate-y-1">
         {/* Header */}
         <div className="flex items-center justify-between px-4 py-3 bg-zinc-50/50 dark:bg-zinc-800/60 border-b border-zinc-100 dark:border-white/10">
            <div className="flex items-center gap-3">
               <div className="w-5 h-3.5 bg-zinc-800 dark:bg-zinc-700 rounded-sm flex items-center justify-center">
            ...
            <div className="flex items-center gap-3">
               ...
               <div className="w-8 h-1 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
               <div className="w-6 h-1 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
               <div className="w-6 h-1 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
            </div>
         ...
         {/* Body */}
         <div className="flex-1 p-5 relative bg-white dark:bg-zinc-900 flex flex-col gap-2.5">
            <div className="flex gap-2">
              <div className="w-[15%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
              <div className="w-[25%] h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full"></div>
            </div>

            <div className="pl-6 flex flex-col gap-2 mt-1">
              <div className="flex gap-2">
                <div className="w-[25%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
                <div className="w-[20%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
                <div className="w-[15%] h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full"></div>
              </div>
              <div className="flex gap-2 relative">
                <div className="w-[20%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
                <div className="w-[25%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
                {/* Dark Selected Code Bar */}
                <div className="relative w-[15%] h-2.5 bg-zinc-800 dark:bg-zinc-300 rounded-full transition-all duration-500 group-hover:w-[20%] max-lg:group-data-[in-view=true]:w-[20%]">
                   {/* Developer Cursor */}
              ...
              <div className="flex gap-2">
                <div className="w-[30%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
                <div className="w-[25%] h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full"></div>
                <div className="w-[15%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
              </div>
            </div>
            ...
            <div className="flex gap-2 mt-1">
              <div className="w-[10%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
              <div className="w-[35%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
            </div>
            <div className="flex gap-2">
              <div className="w-[25%] h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full"></div>
              <div className="w-[20%] h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full"></div>
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden transition-transform duration-500">
       ...
       <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" preserveAspectRatio="none" viewBox="0 0 400 200">
          {/* Center Line */}
          <line x1="200" y1="70" x2="200" y2="100" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
          <line x1="200" y1="102" x2="200" y2="108" className="stroke-zinc-800 dark:stroke-zinc-300" strokeWidth="2.5" strokeLinecap="round" />
          <line x1="200" y1="110" x2="200" y2="160" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
          
          {/* Left Line */}
          <line x1="80" y1="70" x2="80" y2="100" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
          <line x1="80" y1="102" x2="80" y2="108" className="stroke-zinc-800 dark:stroke-zinc-300" strokeWidth="2.5" strokeLinecap="round" />
          <path d="M 80 110 L 80 120 Q 80 130 90 130 L 130 130 Q 140 130 140 140 L 140 160" fill="none" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
          
          {/* Right Line */}
          <line x1="320" y1="70" x2="320" y2="100" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
          <line x1="320" y1="102" x2="320" y2="108" className="stroke-zinc-800 dark:stroke-zinc-300" strokeWidth="2.5" strokeLinecap="round" />
          <path d="M 320 110 L 320 120 Q 320 130 310 130 L 270 130 Q 260 130 260 140 L 260 160" fill="none" className="stroke-zinc-200 dark:stroke-zinc-800" strokeWidth="1.5" />
       </svg>
       
       {/* Left Node */}
       <div className="absolute top-[35%] left-[20%] -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white dark:bg-zinc-850 bg-white dark:bg-zinc-800 rounded-full shadow-[0_6px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_6px_20px_rgba(0,0,0,0.4)] border border-zinc-50 dark:border-white/10 flex items-center justify-center z-10 transition-transform duration-500 hover:scale-110">
       ...
       {/* Center Node */}
       <div className="absolute top-[35%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white dark:bg-zinc-800 rounded-full shadow-[0_6px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_6px_20px_rgba(0,0,0,0.4)] border border-zinc-50 dark:border-white/10 flex items-center justify-center z-10 transition-transform duration-500 hover:scale-110">
       ...
       {/* Right Node */}
       <div className="absolute top-[35%] left-[80%] -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-white dark:bg-zinc-800 rounded-full shadow-[0_6px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_6px_20px_rgba(0,0,0,0.4)] border border-zinc-50 dark:border-white/10 flex items-center justify-center z-10 transition-transform duration-500 hover:scale-110">
  ...
  return (
    <div className="absolute inset-0 group overflow-hidden bg-transparent cursor-pointer">
       ...
       <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" preserveAspectRatio="none" viewBox="0 0 400 300">
           ...
           <path d="M 175 100 L 265 100 Q 280 100 280 115 L 280 200" fill="none" className="stroke-zinc-100 dark:stroke-zinc-800" strokeWidth="6" />
           
           {/* Hover Line 1 (Left Edge) - Fade in */}
           <line x1="120" y1="120" x2="120" y2="200" className="stroke-zinc-100 dark:stroke-zinc-800 opacity-0 group-hover:opacity-100 max-lg:group-data-[in-view=true]:opacity-100 transition-opacity duration-500 delay-200" strokeWidth="6" />
           
           {/* Hover Line 2 (Bottom Edge) - Fade in */}
           <line x1="175" y1="220" x2="225" y2="220" className="stroke-zinc-100 dark:stroke-zinc-800 opacity-0 group-hover:opacity-100 max-lg:group-data-[in-view=true]:opacity-100 transition-opacity duration-500 delay-200" strokeWidth="6" />
           
           {/* Line Joints (Grey Dots) */}
           <rect x="171" y="95.5" width="9" height="9" rx="4.5" className="fill-zinc-300 dark:fill-zinc-700" />
           <rect x="275.5" y="196" width="9" height="9" rx="4.5" className="fill-zinc-300 dark:fill-zinc-700" />
           
           {/* Hover Joints */}
           <rect x="115.5" y="116" width="9" height="9" rx="4.5" className="fill-zinc-300 dark:fill-zinc-700 opacity-0 group-hover:opacity-100 max-lg:group-data-[in-view=true]:opacity-100 transition-opacity duration-500 delay-200" />
           <rect x="115.5" y="196" width="9" height="9" rx="4.5" className="fill-zinc-300 dark:fill-zinc-700 opacity-0 group-hover:opacity-100 max-lg:group-data-[in-view=true]:opacity-100 transition-opacity duration-500 delay-200" />
           <rect x="171" y="215.5" width="9" height="9" rx="4.5" className="fill-zinc-300 dark:fill-zinc-700 opacity-0 group-hover:opacity-100 max-lg:group-data-[in-view=true]:opacity-100 transition-opacity duration-500 delay-200" />
           <rect x="221" y="215.5" width="9" height="9" rx="4.5" className="fill-zinc-300 dark:fill-zinc-700 opacity-0 group-hover:opacity-100 max-lg:group-data-[in-view=true]:opacity-100 transition-opacity duration-500 delay-200" />
       </svg>
       ...
       <div className="absolute top-[33.3%] left-[30%] -translate-x-1/2 -translate-y-1/2 z-10 transition-transform duration-500 hover:scale-[1.03]">
          <div className="bg-[#1c1c1c] dark:bg-zinc-800 text-white text-sm font-bold px-4 py-2 sm:px-5 sm:py-2.5 rounded-full flex items-center gap-2.5 shadow-lg border border-transparent dark:border-white/10">
       ...
       <div className="absolute top-[73.3%] left-[30%] -translate-x-1/2 -translate-y-1/2 z-0 opacity-100 group-hover:opacity-0 max-lg:group-data-[in-view=true]:opacity-0 transition-opacity duration-300">
          <div className="w-[110px] h-[40px] sm:w-[125px] sm:h-[44px] rounded-full border-[1.5px] border-dashed border-zinc-400/80 dark:border-zinc-600"></div>
       </div>
       ...
       <div className="absolute z-20 transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] 
          ...
          <div className="bg-[#1ba453] group-hover:bg-[#1c1c1c] dark:group-hover:bg-zinc-800 max-lg:group-data-[in-view=true]:bg-[#1c1c1c] dark:max-lg:group-data-[in-view=true]:bg-zinc-800 transition-colors duration-700 text-white text-sm font-bold px-4 py-2 sm:px-5 sm:py-2.5 rounded-full flex items-center gap-2.5 shadow-xl border border-transparent dark:border-white/10">
             <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="3" width="18" height="18" rx="4" />
                <line x1="8" y1="9" x2="16" y2="9" />
             </svg>
