...
export function CareerHero() {
  ...
  return (
    <div className="relative pt-36 lg:pt-40 pb-20 flex flex-col overflow-hidden bg-[#f5f5f5] dark:bg-[#09090b] transition-colors duration-200">
      <Navbar2 />
      <motion.section
      ...
      >
        ...
        >
          <Briefcase className="w-3.5 h-3.5 text-zinc-600 dark:text-zinc-300" />
          {hero.pill}
        </motion.div>
        ...
        <motion.a
          variants={itemVariants}
          href={hero.ctaLink}
          className="inline-flex items-center gap-2 bg-black dark:bg-zinc-800 text-white hover:bg-zinc-800 dark:hover:bg-zinc-700 px-7 py-3 rounded-full text-sm font-semibold transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105"
        >
