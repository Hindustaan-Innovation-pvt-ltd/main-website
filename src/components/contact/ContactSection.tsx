...
function ContactSectionContent() {
  ...
  return (
    <div className="relative min-h-screen bg-[#f0f2f5] overflow-hidden">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white border border-zinc-200 rounded-full shadow-sm mb-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-black leading-[1.1] mb-5">
            {contactPage.heading}{" "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            <motion.div
              ...
              className="group relative overflow-hidden bg-white rounded-2xl border border-zinc-200/80 p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-zinc-900 mb-1">{contactPage.emailUs.title}</h3>
                  <p className="text-sm text-zinc-500 leading-relaxed mb-3">{contactPage.emailUs.description}</p>
                  <a
            ...
            >
              <div className="flex items-start gap-4">
                <div className="shrink-0 w-11 h-11 flex items-center justify-center rounded-xl bg-zinc-900/8 border border-zinc-200">
                  <Headphones className="w-5 h-5 text-zinc-700" />
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-zinc-900 mb-1">{contactPage.contactSales.title}</h3>
                  <p className="text-sm text-zinc-500 leading-relaxed mb-3">{contactPage.contactSales.description}</p>
            ...
            <motion.div
              variants={itemVariants}
              className="bg-white rounded-2xl border border-zinc-200/80 overflow-hidden shadow-sm"
            >
              {/* Head Office */}
              <div className="p-6 border-b border-zinc-100 group hover:bg-zinc-50/60 transition-colors duration-200">
                <div className="flex items-start gap-4">
                  <div className="shrink-0 w-11 h-11 flex items-center justify-center rounded-xl bg-blue-50 border border-blue-100">
                    <Building2 className="w-5 h-5 text-blue-600" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-zinc-900 mb-1">Head Office</h3>
                    <p className="text-sm text-zinc-500 leading-relaxed mb-3">
                      Hindustaan Innovations Private Limited<br />
                      CO: B-41, Sector-8A, Kamal-Vihar,<br />
                      Raipur (C.G.) — 492001<br />
                      <span className="text-zinc-600 font-medium">Phone: 0771-299-4005</span>
                    </p>
                    <button
              ...
              {/* Registered Office */}
              <div className="p-6 group hover:bg-zinc-50/60 transition-colors duration-200">
                <div className="flex items-start gap-4">
                  <div className="shrink-0 w-11 h-11 flex items-center justify-center rounded-xl bg-purple-50 border border-purple-100">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-sm font-semibold text-purple-600 hover:gap-2.5 transition-all duration-200"
                    >
                      View on map
                      <ArrowRight className="w-3.5 h-3.5" />
                    </button>
          ...
          <motion.div
            variants={itemVariants}
            className="lg:col-span-7 bg-white rounded-2xl border border-zinc-200/80 shadow-sm overflow-hidden flex flex-col"
          >
            {/* Form Header */}
            <div className="px-8 pt-8 pb-6 border-b border-zinc-100">
              <div className="flex items-center gap-3 mb-1">
                ...
                <h2 className="text-2xl font-bold text-zinc-900">{contactPage.form.heading}</h2>
              </div>
              <p className="text-sm text-zinc-500 ml-12">Fill in the details below and we&apos;ll get back to you shortly.</p>
            </div>
              ...
              <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className={`w-full px-4 py-3 rounded-xl border text-sm text-zinc-900 placeholder:text-zinc-400 bg-zinc-50 outline-none transition-all duration-200 focus:bg-white focus:border-[#1ba453] focus:ring-2 focus:ring-[#1ba453]/15 disabled:opacity-50 ${form.name.touched && form.name.error ? 'border-red-400 bg-red-50' : 'border-zinc-200'}`}
                    />
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className={`w-full px-4 py-3 rounded-xl border text-sm text-zinc-900 placeholder:text-zinc-400 bg-zinc-50 outline-none transition-all duration-200 focus:bg-white focus:border-[#1ba453] focus:ring-2 focus:ring-[#1ba453]/15 disabled:opacity-50 ${form.email.touched && form.email.error ? 'border-red-400 bg-red-50' : 'border-zinc-200'}`}
                    />
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className={`w-full px-4 py-3 rounded-xl border text-sm text-zinc-900 placeholder:text-zinc-400 bg-zinc-50 outline-none transition-all duration-200 focus:bg-white focus:border-[#1ba453] focus:ring-2 focus:ring-[#1ba453]/15 disabled:opacity-50 ${form.phone.touched && form.phone.error ? 'border-red-400 bg-red-50' : 'border-zinc-200'}`}
                    />
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className={`w-full px-4 py-3 rounded-xl border text-sm text-zinc-900 placeholder:text-zinc-400 bg-zinc-50 outline-none transition-all duration-200 focus:bg-white focus:border-[#1ba453] focus:ring-2 focus:ring-[#1ba453]/15 disabled:opacity-50 ${form.subject.touched && form.subject.error ? 'border-red-400 bg-red-50' : 'border-zinc-200'}`}
                    />
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea
                    ...
                    disabled={loading}
                    className={`w-full px-4 py-3 rounded-xl border text-sm text-zinc-900 placeholder:text-zinc-400 bg-zinc-50 outline-none transition-all duration-200 focus:bg-white focus:border-[#1ba453] focus:ring-2 focus:ring-[#1ba453]/15 resize-none disabled:opacity-50 ${form.message.touched && form.message.error ? 'border-red-400 bg-red-50' : 'border-zinc-200'}`}
                  />
              ...
              <div className="mt-auto pt-6">
                <div className="border-t border-zinc-100 pt-5">
                  <div className="grid grid-cols-3 gap-3">
                    <div className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-zinc-50 border border-zinc-100">
                      <span className="text-xl font-extrabold text-[#1ba453]">On Time</span>
                      <span className="text-[11px] font-medium text-zinc-500 text-center leading-tight">Project Delivery</span>
                    </div>
                    <div className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-zinc-50 border border-zinc-100">
                      <span className="text-xl font-extrabold text-[#1ba453]">24h</span>
                      <span className="text-[11px] font-medium text-zinc-500 text-center leading-tight">Response Time</span>
                    </div>
                    <div className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-zinc-50 border border-zinc-100">
                      <span className="text-xl font-extrabold text-[#1ba453]">100%</span>
                      <span className="text-[11px] font-medium text-zinc-500 text-center leading-tight">Client Satisfaction</span>
                    </div>
                  </div>
        ...
        <motion.div variants={itemVariants} className="mt-8" ref={mapRef}>
          ...
          <div className="flex items-center gap-3 mb-4">
            <button
              onClick={(e) => handleViewMap(e, 'head')}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border transition-all duration-200 ${activeMap === 'head' ? 'bg-blue-600 text-white border-blue-600 shadow-md' : 'bg-white text-zinc-600 border-zinc-200 hover:border-blue-300 hover:text-blue-600'}`}
            >
            ...
            <button
              onClick={(e) => handleViewMap(e, 'registered')}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border transition-all duration-200 ${activeMap === 'registered' ? 'bg-purple-600 text-white border-purple-600 shadow-md' : 'bg-white text-zinc-600 border-zinc-200 hover:border-purple-300 hover:text-purple-600'}`}
            >
          ...
          <div className="w-full rounded-2xl overflow-hidden border border-zinc-200 shadow-md">
            <iframe
              src={mapSrc}
              loading="eager"
              className="w-full"
